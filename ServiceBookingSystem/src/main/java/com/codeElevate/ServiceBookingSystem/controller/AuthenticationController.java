...
import com.codeElevate.ServiceBookingSystem.services.authentification.AuthService;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> signupClient(@RequestBody SignupRequestDTO signupRequestDTO){
        ...
        if(authService.presentByEmail(signupRequestDTO.getEmail())){
            return new ResponseEntity<>("Client already exists with this mail", HttpStatus.NOT_ACCEPTABLE);
        }
    ...
    public ResponseEntity<?> signupCompany(@RequestBody SignupRequestDTO signupRequestDTO){
        ...
        if(authService.presentByEmail(signupRequestDTO.getEmail())){
            return new ResponseEntity<>("Company already exists with this mail", HttpStatus.NOT_ACCEPTABLE);
        }
